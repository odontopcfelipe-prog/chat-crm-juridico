    ...
    <div className={`border rounded-xl overflow-hidden transition-colors ${
      ...
      >
        ...
        <span className="w-[120px] shrink-0 flex items-center justify-start">
          {(() => {
            // Onda 17.74 — sem prioridade definida = LIVRE (espelha o card "Versão
            // livre" das Propostas). ANTES caía em `|| 'COMPLETO'`: um orçamento SEM
            // prioridade aparecia como "COMPLETO" aqui e como "Versão livre" nas
            // Propostas — os dois nunca batiam, confundindo o operador.
            const p = quote.priority || 'LIVRE';
            const cfg = {
