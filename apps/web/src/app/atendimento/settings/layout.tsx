...
const settingsSections: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Funis de CRC', href: '/atendimento/settings/pipelines', icon: Kanban },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Sugestões Clínicas', href: '/atendimento/settings/sugestoes-clinicas', icon: Lightbulb },
