...
export const STAGE_TEMPLATES: Partial<Record<string, { label: string; text: string }>> = {
  QUALIFICANDO:     { label: 'Iniciar triagem', text: 'Olá! Estamos analisando sua solicitação. Poderia me contar um pouco mais sobre o que você precisa para que possamos ajudá-lo melhor?' },
  ...
  FINALIZADO:       { label: 'Agradecer conversão', text: 'Olá! É um prazer tê-lo como nosso cliente. Nossa equipe estará dedicada ao seu atendimento. Em breve entraremos em contato com os próximos passos!' },
};
