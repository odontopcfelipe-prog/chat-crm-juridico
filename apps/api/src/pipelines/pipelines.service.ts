...
const PIPELINE_TEMPLATES = {
  ...
  'lentes-porcelana': {
    ...
    description:
      'Funil dedicado para LENTES DE CONTATO DENTAL (porcelana / cerâmica) e FACETAS DE PORCELANA — canal PREMIUM. Lead chegou por campanha específica focada em estética premium, transformação completa do sorriso, ou referências de celebridades. Frequentemente tem ORÇAMENTO ALTO e EXPECTATIVA ESPECÍFICA. A IA "Sophia — Especialista em Porcelana" conduz da descoberta ao agendamento com TOM DE PARCEIRA À ALTURA — sem ostentação, sem infantilização, com honestidade técnica. Mock-up é destacado como diferencial central (testa antes de fechar). NÃO menciona resina automaticamente — só se lead perguntar (downsell agressivo proibido). Gestão de expectativa CRÍTICA (irreversibilidade do desgaste em tradicional, processo de várias consultas, "resultado em direção, não cópia").',
    color: '#8b5cf6',
    stages: [
      { name: 'Inicial', slug: 'inicial', emoji: '👋', color: '#6b7280', position: 0, is_initial: true, description: 'Lead acabou de chegar no funil de lentes de porcelana (recebido do SDR ou começou direto via campanha premium).' },
      { name: 'Descoberta', slug: 'descoberta', emoji: '🔍', color: '#8b5cf6', position: 1, description: 'IA está investigando a queixa real, referência visual (foto/famosa), expectativa (natural-premium ou marcado), quantidade pretendida.' },
      { name: 'Educando', slug: 'educando', emoji: '📚', color: '#a855f7', position: 2, description: 'IA está explicando lente de porcelana — tradicional vs ultrafina, processo (várias consultas), durabilidade (10-15 anos), mock-up como segurança.' },
      { name: 'Gestão de Expectativa', slug: 'gestao-expectativa', emoji: '🧭', color: '#0ea5e9', position: 3, description: 'CRÍTICO em porcelana: IA calibra IRREVERSIBILIDADE (desgaste em tradicional é definitivo), processo (não fica num dia), MOCK-UP (testa antes), "resultado em DIREÇÃO da referência, não cópia". Mock-up é destacado como diferencial central que justifica o investimento.' },
